...
exports.SemanticScholarTS = function SemanticScholarTS(req, res) {

  console.log(req.query.q)

  SemanticScholarTS(req, res);
  async function SemanticScholarTS(req, res) {
    ...
    async function getSearchResults() {
      ...
      res.status(200).send(await getResults);
      await browser.close();
    ...
    async function getPaperDetails() {
      ...
      res.status(200).send(JSON.stringify(await getDetail));
      await browser.close();
